var GlobeTextDrawer = function () {
    this.init.apply(this, arguments);
};

GlobeTextDrawer.prototype = {
    viewer: null,
    scene: null,
    clock: null,
    canvas: null,
    ...
    okHandler: null,
    cancelHandler: null,
    image: "CesiumPlugins/drawingtools/images/text.png",
    toolBarIndex: null,
    ...
    showModifyText: function (position, okHandler, cancelHandler) {
        var _this = this;
    ...
    startDrawText: function (okHandler, cancelHandler) {
        var _this = this;
        _this.okHandler = okHandler;
        _this.cancelHandler = cancelHandler;
        _this.entity = null;
