...
GlobeTracker.prototype = {
    ...
    init: function (viewer) {
        ...
        _this.textDrawer = new GlobeTextDrawer(_this.viewer);
        _this.ctrArr.push(_this.textDrawer);
    ...
    clear: function () {
        ...
        for (var i = 0; i < _this.ctrArr.length; i++) {
            try {
                ...
                console.log("An unknown error occurred：GlobeTracker.clear");
            }
        }
    },
    trackPoint: function (img, okHandler, cancelHandler) {
        var _this = this;
        _this.clear();
        ...
        _this.pointDrawer.startDrawPoint(img, okHandler, cancelHandler);
    },
    trackText: function (okHandler, cancelHandler) {
        var _this = this;
        _this.clear();
        if (_this.textDrawer == null) {
            _this.textDrawer = new GlobeTextDrawer(_this.viewer);
            _this.ctrArr.push(_this.textDrawer);
        }
        _this.textDrawer.startDrawText(okHandler, cancelHandler);
    },
    ...
    trackWall: function (okHandler, cancelHandler) {
        var _this = this;
        _this.clear();
        if (_this.wallDrawer == null) {
            _this.wallDrawer = new GlobeWallDrawer(_this.viewer);
            _this.ctrArr.push(_this.wallDrawer);
        }
        _this.wallDrawer.startDrawWall(okHandler, cancelHandler);
    },
    trackWeapon: function (okHandler, cancelHandler) {
        var _this = this;
        _this.clear();
        if (_this.weaponDrawer == null) {
            _this.weaponDrawer = new GlobeWeaponDrawer(_this.viewer);
            _this.ctrArr.push(_this.weaponDrawer);
        }
        _this.weaponDrawer.startDrawWeapon(okHandler, cancelHandler);
    },
