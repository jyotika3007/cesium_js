...
// function entRotation(startPos, hrotAngle){
//     let centerPoint = Cesium.Cartographic.fromCartesian(startPos);
...
//     let directionX = range * Math.cos(Cesium.Math.toRadians(hrotAngle));
//     let directionY = range * Math.sin(Cesium.Math.toRadians(hrotAngle));
...
function showWeapon(objId, position, latLon) {
    ...
    if (wallAnimPropsDic[objId]["flat"]) {
        ...
        bData.box = {
            dimensions: new Cesium.Cartesian3(8 * wallAnimPropsDic[objId]["scale"], 8 * wallAnimPropsDic[objId]["scale"], 8 * wallAnimPropsDic[objId]["scale"]),
            //material: new Cesium.ImageMaterialProperty({ image: wallAnimPropsDic[objId]["img"], transparent: true}),
            material: Cesium.Color.GREEN.withAlpha(0.7), //wallAnimPropsDic[objId]["img"],
            outline: true,
            clampToGround: true,
            heightReference: Cesium.HeightReference.CLAMP_TO_GROUND
        }

        var scaller = 32 * wallAnimPropsDic[objId]["scale"];
        // console.log("scaller", scaller)
        // bData.plane = {
        //     plane: new Cesium.Plane(Cesium.Cartesian3.UNIT_X, scaller),
        //     dimensions: new Cesium.Cartesian3(scaller, scaller),
        //     material: new Cesium.ImageMaterialProperty({
        //         image:wallAnimPropsDic[objId]["img"],
