    ...
    Cesium.HeightDepthCalc = (function (Cesium) {
        ...
        _.prototype = {
            ...
            calcHeightDepth: function () {
                let $this = this;
                getPolygonInsideCoordinates($this.positionsST, function (pointGridCoordinates) {
                    getUpdatedCoordinates(pointGridCoordinates, 100, function (updatedPositions) {
                        //get max heighted location
                        let updatedCoordsHeight = [];
                        pointGridCoordinates.forEach((p, i) => {
                            if (updatedPositions[i].height !== undefined) {
                        ...
                        if (updatedCoordsHeight.length > 0) {
                            ...
                            let Mxent = {
                                ...
                                label: {
                                    text: `Height: ${maxHeightLocation.height.toFixed(2)}m\nLon: ${maxHeightLocation.lan.toFixed(2)}\nLat: ${maxHeightLocation.lat.toFixed(2)}`,
                            ...
                            let Mnent = {
                                ...
                                label: {
                                    text: `Height: ${minHeightLocation.height.toFixed(2)}m\nLon: ${minHeightLocation.lan.toFixed(2)}\nLat: ${minHeightLocation.lat.toFixed(2)}`,
                                    font: '14px sans-serif',
                                    showBackground: true,
                                    font: '14px sans-serif',
                                    horizontalOrigin: Cesium.HorizontalOrigin.LEFT,
