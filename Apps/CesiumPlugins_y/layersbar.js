...
function _processLayersStacking() {
    ...
    vEnts.forEach(en => {
        if ((en._groupLayerName === undefined || en._groupLayerName === "" || en._groupLayerName === null) && en.objType !== "osm3d") {
...
function _initLayerSelectorHandler() {
    ...
    handler.setInputAction(function (movement) {
        ...
        if (pick) {
            if (pick.id !== undefined && pick.id._groupLayerName !== undefined && pick.id.objType !== "osm3d") {
