...
function toggleConfigurations() {
    ...
    weatherPanelLoader(function () {
        ...
        bindToolbar(weathers.viewModal1, "config_toolbar1", "weathers.updateTimer();");
    });
}
/* END */
...
/* HEIGHTDEPTH ANALYSIS */
function toggleheightDepthCalc(el) {
    if (heightDepthCalc === undefined) return;
    heightDepthCalcPanelLoader(function () {
        bindToolbar(heightDepthCalc.viewModel, "heightDepthCalc_toolbar", "heightDepthCalc.updateHeightDepth()");
    });
}
/* END */
...
function _initialiseBasics() {
    ...
    heightDepthCalc = new Cesium.HeightDepthCalc(viewer);
