var CesiumMeasurer = (function () {
    ...
    function _(cesiumWidget) {
        this._drawLayer = new Cesium.CustomDataSource('measureCutVolumeLayer')
        cesiumWidget && cesiumWidget.dataSources.add(this._drawLayer)
    ...
    _.BillboardGroup = function (drawHelper, options) {
        ...
        //this._drawHelper._drawLayer.entities.add(b);
        this._billboards = b;
    ...
    _.prototype.cleanUp = function () {
        if (this._prevEntity != undefined) {
            this._drawLayer.entities.remove(this._prevEntity);
        ...
        if (this._volumeLabel != undefined) {
            ...
            this._drawLayer.entities.remove(this._volumeLabel);
    ...
    _.prototype.startDrawing = function (options) {
        var $this = this;
        this._tooltip = createTooltip(this._cesiumViewer.container);
            ...
            if (movement.position != null) {
                ...
                if (cartesian) {
                    ...
                    if (positions.length >= minPoints) {
                        ...
                        $this._prevEntity = $this._drawLayer.entities.add(drawingPolygon);
                    }
                }
            }
    ...
    _.prototype.stopMeassure = function () {
        this._tooltip.setVisible(false);
    ...
    _.prototype.computeCutVolume = function () {
        ...
        for (i = 0; i < geom.indices.length; i += 3) {
            ...
            if (this._debugShowSubTriangles) {
                ...
                this._drawLayer.entities.add(drawingPolygon);
            }
        ...
        this._volumeLabel = this._drawLayer.entities.add({
            position: Cesium.Cartesian3.fromRadians(centroid.longitude, centroid.latitude, maxHeight + 1000),
            label: {
                text: 'Cut Volume ' + totalCutVolume.toFixed(4).toString() + ' m3',
                show: true,
                showBackground: true,
