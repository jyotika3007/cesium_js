...
function topToolbarLoader() {
    ...
    <div class="button" title="Download Snapshot" style="width: 30px; margin-right: 5px;" onclick="downloadSnapshot();">
        <img src="./img/snapshot.png">
    </div>
    <div class="button" id="osm3dbuilding" title="3D Buildings" style="width: 30px; margin-right: 5px;" onclick="update3dbuildings();">
        <img src="./img/3d-cube.png">
    </div>
    </div>`));
}
...
function bottomToolbarLoader() {
    ...
    <div class="leftpan"><span id="_progressLoaderSpan"><svg class="rotateMe" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="white" stroke="black" d="M304 48c0 26.51-21.49 48-48 48s-48-21.49-48-48 21.49-48 48-48 48 21.49 48 48zm-48 368c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zm208-208c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.49-48-48-48zM96 256c0-26.51-21.49-48-48-48S0 229.49 0 256s21.49 48 48 48 48-21.49 48-48zm12.922 99.078c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.491-48-48-48zm294.156 0c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48c0-26.509-21.49-48-48-48zM108.922 60.922c-26.51 0-48 21.49-48 48s21.49 48 48 48 48-21.49 48-48-21.491-48-48-48z"></path></svg></span><div class="_latlonger"></div></div>
...
function showLatLonMoving(event) {
    ...
    if (Cesium.defined(mousePosition)) {
        ...
        $(".bottomToolbar>.leftpan>._latlonger").html(lhtext);
...
function dynamic_cosmetic_change() {
    let temporary_selected_Entity_array = viewer.entities.values.filter(v => {
        return v.istemporary
    });
...
function weatherPanelLoader(_cb) {
    ...
    <div id="toolbarPanelContent">
        <div id="config_toolbar1">
            <table style="width:100%;">
            <tbody>
                <tr>
                    <td>
                        <p class="collapsible">Sun Positioning</p>
                        <div class="content" style="margin-top:5px;">
                            <label><input type="checkbox" data-bind="checked: globelightening_enabled">
                                Day/Night Lightening</label><br>
                            <label><input type="checkbox" data-bind="checked: isautotimer">
                                Auto Time</label><br>
                            <label>Hrs: <input type="number" style="width:36px;" min="00" max="23" step="1"
                                    data-bind="value:currhrs"> Mins: <input type="number" style="width:36px;" min="00" max="59" step="1"
                                    data-bind="value:currmins"> Secs: <input type="number" style="width:36px;" min="00" max="59" step="1"
                                    data-bind="value:currsecs"></label>
                        </div>
                    </td>
                </tr>
            </tbody>
        ...
        <div id="viewshad3d_toolbar">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><label><input type="checkbox" data-bind="checked: softShadows">&nbsp;Soft Shadows</label></td>
                </tr>
            </tbody>
        </table>
        <hr>
    ...
    if (objId && _symbolData && !_symbolData["displayInfo"]) {
        ...
        <tr>
            ...
            <table style="100%;">
                ...
                <tr>
                    <td>
                        <input type="number" style="width:100%;" min="0" max="255" step="1" data-bind="value: fillColorRed">
                    </td><td>
                        <input type="number" style="width:100%;" min="0" max="255" step="1" data-bind="value: fillColorGreen">
                    </td><td>
                        <input type="number" style="width:100%;" min="0" max="255" step="1" data-bind="value: fillColorBlue">
                    </td><td>
                        <input type="number" style="width:100%;" min="0" max="1.0" step="0.1" data-bind="value: fillColorAlpha">
                    </td>
                    </td><td>
                        <div data-bind="style: {'width':'20px', 'height':'20px', 'background-color':rgbaTostr(fillColorRed,fillColorGreen,fillColorBlue,fillColorAlpha)}"></div>
                    </td>
                </tr>
            </table>
            </td>
        ...
        <tr>
            ...
            <table style="100%;">
                ...
                <tr>
                    <td>
                        <input type="number" style="width:100%;" min="0" max="255" step="1" data-bind="value: strokeColorRed">
                    </td><td>
                        <input type="number" style="width:100%;" min="0" max="255" step="1" data-bind="value: strokeColorGreen">
                    </td><td>
                        <input type="number" style="width:100%;" min="0" max="255" step="1" data-bind="value: strokeColorBlue">
                    </td><td>
                        <input type="number" style="width:100%;" min="0" max="1.0" step="0.1" data-bind="value: strokeColorAlpha">
                    </td>
                    </td><td>
                        <div data-bind="style: {'width':'20px', 'height':'20px', 'background-color':rgbaTostr(strokeColorRed,strokeColorGreen,strokeColorBlue,strokeColorAlpha)}"></div>
                    </td>
                </tr>
            </table>
            </td>
        ...
        <tr>
            ...
            <table style="100%;">
                ...
                <tr>
                    <td>
                        <input type="number" style="width:100%;" min="0" max="255" step="1" data-bind="value: bgColorRed">
                    </td><td>
                        <input type="number" style="width:100%;" min="0" max="255" step="1" data-bind="value: bgColorGreen">
                    </td><td>
                        <input type="number" style="width:100%;" min="0" max="255" step="1" data-bind="value: bgColorBlue">
                    </td><td>
                        <input type="number" style="width:100%;" min="0" max="1.0" step="0.1" data-bind="value: bgColorAlpha">
                    </td>
                    </td><td>
                        <div data-bind="style: {'width':'20px', 'height':'20px', 'background-color':rgbaTostr(bgColorRed,bgColorGreen,bgColorBlue,bgColorAlpha)}"></div>
                    </td>
                </tr>
            </table>
            </td>
