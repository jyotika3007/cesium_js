var GlobeWeaponDrawer = function () {
    this.init.apply(this, arguments);
};

GlobeWeaponDrawer.prototype = {
    viewer: null,
    scene: null,
    clock: null,
    canvas: null,
    ...
    showModifyWeapon: function (img, position, okHandler, cancelHandler) {
        var _this = this;
        _this.position = position;
        _this.okHandler = okHandler;
        _this.cancelHandler = cancelHandler;
        _this.image = img["img"];
        _this.scale = img["scale"];
        _this.entity = null;
        _this._createWeapon();
        _this._startModify();
    },
    startDrawWeapon: function (img, okHandler, cancelHandler) {
        var _this = this;
        if (img) {
            _this.image = img["img"];
            _this.scale = img["scale"];
        ...
        _this.drawHandler.setInputAction(function (event) {
            ...
            if (_this.position == null) {
                _this.tooltip.showAt(wp, "<p>Select location</p>");
            }
            var ray = _this.camera.getPickRay(wp);
            if (!Cesium.defined(ray)) {
                return;
    ...
    _startModify: function () {
        ...
        _this.modifyHandler.setInputAction(function (event) {
            ...
            if (isMoving) {
                ...
                pickedAnchor = entity;
                isMoving = true;
                _this.tooltip.showAt(wp, "<p>Move location</p>");
            }
        }, Cesium.ScreenSpaceEventType.LEFT_CLICK);
