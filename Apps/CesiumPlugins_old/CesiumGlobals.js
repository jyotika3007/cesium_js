...
const getUpdatedCoordinates = function (cc, _cb) { //cc must be in array of [[lon,lat],[lon,lat]]
...
const getPolygonInsideCoordinates = (polygonArrayInDegress, cellSideMeter = 1.0, _cb) => {
