                ...
                i = {
                    ...
                    page: (function () {
                        ...
                        for (u - r < t - 1 && (r = u - t + 1), a.first !== !1 && r > 2 && e.push('<span class="layui-laypage-spr">&#x2026;</span>'); r <= u; r++)
                            r === a.curr
                                ? e.push('<span class="layui-laypage-curr"><em class="layui-laypage-em" ' + (/^#/.test(a.theme) ? 'style="background-color:' + a.theme + ';"' : "") + "></em><em>" + r + "</em></span>")
                    ...
                    skip: (function () {
                        return [
                            ...
                            '&#x9875;<button type="button" class="layui-laypage-btn">Ok</button>',
                            "</span>",
                        ].join("");
                    })(),
                };
            ...
            var e = this,
                ...
                n = {
                    cn: {
                        ...
                        tools: { confirm: "Ok", clear: "清空", now: "现在" },
                    },
                    en: {
...
!(function (e, t) {
    ...
    function j(e) {
        ...
        return (
            ...
            ((n = D(e, t)),
                ("none" !== n && n) ||
                ((ut = (ut || pe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement)), (t = (ut[0].contentWindow || ut[0].contentDocument).document), t.write(), t.close(), (n = D(e, t)), ut.detach()),
                (lt[e] = n)),
            n
        );
    }
        ...
        for (var n, r, i, o = [], a = 0, s = e.length; a < s; a++)
            (r = e[a]),
                ...
                ((o[a] = pe._data(r, "olddisplay")),
                    (n = r.style.display),
                    t
                        ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && Re(r) && (o[a] = pe._data(r, "olddisplay", j(r.nodeName))))
    ...
    function F(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2)
            "margin" === n && (a += pe.css(e, n + Oe[o], !0, i)),
                r
                    ? ("content" === n && (a -= pe.css(e, "padding" + Oe[o], !0, i)), "margin" !== n && (a -= pe.css(e, "border" + Oe[o] + "Width", !0, i)))
                    ...
                    for (r in i)
                        (e = a[r]),
                            ...
                            (l && n && (pe.isPlainObject(n) || (t = pe.isArray(n)))
                                ? (t ? ((t = !1), (o = e && pe.isArray(e) ? e : [])) : (o = e && pe.isPlainObject(e) ? e : {}), (a[r] = pe.extend(l, o, n)))
                                : void 0 !== n && (a[r] = n));
            return a;
        }),
        pe.extend({
                ...
                preFilter: {
                    ...
                    PSEUDO: function (e) {
                        ...
                        return pe.CHILD.test(e[0])
                            ? null
                            : (e[3] ? (e[2] = e[4] || e[5] || "") : n && fe.test(n) && (t = N(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                    },
                },
                filter: {
                    TAG: function (e) {
                            ...
                            : function (t, n, u) {
                                ...
                                if (m) {
                                    ...
                                    if (((h = [a ? m.firstChild : m.lastChild]), a && v)) {
                                        for (
                                            d = m, f = d[P] || (d[P] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), l = c[e] || [], p = l[0] === W && l[1], x = p && l[2], d = p && m.childNodes[p];
                                        ...
                                        for (
                                            ;
                                            (d = (++p && d && d[g]) || (x = p = 0) || h.pop()) &&
                                            ((s ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++x || (v && ((f = d[P] || (d[P] = {})), (c = f[d.uniqueID] || (f[d.uniqueID] = {})), (c[e] = [W, x])), d !== t));
                ...
                for (a = pe.event.handlers.call(this, e, u), t = 0; (i = a[t++]) && !e.isPropagationStopped();)
                    for (e.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !e.isImmediatePropagationStopped();)
                        (e.rnamespace && !e.rnamespace.test(o.namespace)) ||
                            ((e.handleObj = o), (e.data = o.data), (r = ((pe.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)), void 0 !== r && (e.result = r) === !1 && (e.preventDefault(), e.stopPropagation()));
    ...
    pe.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (
                (fe.html5Clone || pe.isXMLDoc(e) || !et.test("<" + e.nodeName + ">") ? (o = e.cloneNode(!0)) : ((st.innerHTML = e.outerHTML), st.removeChild((o = st.firstChild))),
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (
                    ((o = typeof n),
                        ...
                        null != n &&
                        n === n &&
                        ("number" === o && (n += (i && i[3]) || (pe.cssNumber[s] ? "" : "px")), fe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r)))))
                )
                    try {
                        u[t] = n;
                    } catch (l) { }
                ...
                i.extend(
                    {
                        ...
                        yes: function (i) {
                            var n = s.val();
                            "" === n ? s.focus() : n.length > (e.maxlength || 500) ? r.tips("Maximum input" + (e.maxlength || 500) + "Word count", s, { tips: 1 }) : t && t(n, i, s);
                        },
                    },
                    e
                )
        ...
        (r.photos = function (t, n, a) {
            ...
            if (((t = t || {}), t.photos)) {
                ...
                if ((delete t.success, l)) {
                    if (0 === u.length) return r.msg("No image");
                } else {
                    var p = i(t.photos),
                        h = function () {
                            (u = []),
...
layui.define("layer", function (e) {
    ...
    (p.prototype.config = { accept: "images", exts: "", auto: !0, bindAction: "", url: "", field: "file", method: "post", data: {}, drag: !0, size: 0, number: 0, multiple: !1 }),
                    ...
                    o.elemFile.parent().submit(),
                        ...
                        (p.timer = setInterval(function () {
                            ...
                            try {
                                ...
                                o.msg("An exception occurred while obtaining the response information after uploading"), clearInterval(p.timer), m();
                            }
                ...
                d = function (e, i) {
                    if ((o.elemFile.next("." + s).remove(), (r.value = ""), "object" != typeof i))
                        try {
                            ...
                            return (i = {}), o.msg("Please return valid JSON to the upload interface");
                        }
...
layui.define("jquery", function (e) {
    ...
    (p.prototype.config = { type: "default", min: 0, max: 100, value: 0, step: 1, showstep: !1, tips: !0, input: !1, range: !1, height: 200, disabled: !1, theme: "#009688" }),
        (p.prototype.render = function () {
            ...
            var m = t.disabled ? "#c2c2c2" : t.theme,
                p =
                    ...
                    m +
                    ';"></div></div>' +
                    (t.range ? '<div class="layui-slider-wrap" style="' + ("vertical" === t.type ? "bottom" : "left") + ":" + v + ';"><div class="layui-slider-wrap-btn" style="border: 2px solid ' + m + ';"></div></div>' : "") +
                    "</div>",
                h = i(t.elem),
                y = h.next("." + s);
            if (
                ...
                e.elemTemp
                    ...
                    .on("mouseover", function () {
                        ...
                        e.elemTemp.find("." + d).html(u),
                            "vertical" === t.type ? e.elemTemp.find("." + d).css({ bottom: s + "%", "margin-bottom": "20px", display: "inline-block" }) : e.elemTemp.find("." + d).css({ left: s + "%", display: "inline-block" });
                    })
        ...
        (p.prototype.slide = function (e, t, a) {
            var n = this,
                ...
                x = function (e, i) {
                    ...
                    "vertical" === l.type
                        ? (s.find("." + d).css({ bottom: e + "%", "margin-bottom": "20px" }), (t = T(p() - h[0].offsetTop - h.height())), (a = l.range ? T(p() - h[1].offsetTop - h.height()) : 0))
                        : s.find("." + d).css("left", e + "%"),
                        (t = t > 100 ? 100 : t),
                        (a = a > 100 ? 100 : a);
                    var n = Math.min(t, a),
            ...
            var e = this,
                ...
                t = (e.elemPicker = i(
                    [
                            ...
                            if (o.predefine) {
                                ...
                                return (
                                    layui.each(o.colors, function (i, o) {
                                        e.push(
                                            ['<div class="layui-colorpicker-pre' + ((o.match(/[0-9]{1,3}/g) || []).length > 3 ? " layui-colorpicker-pre-isalpha" : "") + '">', '<div style="background:' + o + '"></div>', "</div>"].join("")
                                        );
                                    }),
                                    e.push("</div>"),
                                    e.join("")
                        ...
                        '<button class="layui-btn layui-btn-sm" colorpicker-events="confirm">Ok</button>',
                        "</div",
                        "</div>",
                        "</div>",
                    ].join("")
                                        ...
                                        k
                                            ...
                                            .on("keydown", function (e) {
                                                ...
                                                var t = function (i, a) {
                                                    ...
                                                    return (
                                                        (l = r[i]()), (n = r[i]("dd:not(." + o + ")")), l[0] ? ((y = r[i]()), (n[0] && !n.hasClass(c)) || !y[0] ? (n.addClass(s).siblings().removeClass(s), void $()) : t(i, y)) : (y = null)
                                                    );
                                                };
    ...
    (r.prototype.init = function (e) {
                        ...
                        [
                            ...
                            (function () {
                                return (
                                    ...
                                    ">" +
                                    ('<i class="layui-icon layui-tree-' + (l ? "branch" : "leaf") + '">' + (l ? (n.spread ? t.branch[1] : t.branch[0]) : t.leaf) + "</i>") +
        ...
        (r.prototype.spread = function (e, o) {
            var a = this,
                ...
                l = function () {
                    e.data("spread")
                        ? (e.data("spread", null), r.removeClass("layui-show"), i.html(t.arrow[0]), n.find(".layui-icon").html(t.branch[0]))
                        : (e.data("spread", !0), r.addClass("layui-show"), i.html(t.arrow[1]), n.find(".layui-icon").html(t.branch[1]));
                };
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    (j.prototype.config = { limit: 10, loading: !0, cellMinWidth: 60, defaultToolbar: ["filter", "exports", "print"], text: { none: "无数据" } }),
                    ...
                    layui.each(r, function (i, d) {
                        ...
                        return d
                            ? void (
                                d.colGroup ||
                                d.hide ||
                                (e ? l && l < s && (a--, (c = s)) : ((c = d.width || 0), /\d+%$/.test(c) ? ((c = Math.floor((parseFloat(c) / 100) * o)), c < s && (c = s)) : c || ((d.width = c = 0), a++)), d.hide && (c = 0), (n += c))
                            )
                            : void r.splice(i, 1);
                    });
                }),
                        ...
                        success: function (t) {
                            "function" == typeof a.parseData && (t = a.parseData(t) || t),
                                t[n.statusName] != n.statusCode
                                    ? (i.renderForm(), i.layMain.html('<div class="' + h + '">' + (t[n.msgName] || "返回的数据不符合规范，正确的成功状态码 (" + n.statusName + ") 应为：" + n.statusCode) + "</div>"))
        ...
        (j.prototype.renderData = function (e, n, o, r) {
            ...
            return (
                ...
                r
                    ? m()
                    : 0 === u.length
                        ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + h).remove(), c.layMain.append('<div class="' + h + '">' + s.text.none + "</div>"))
                        : (m(),
                            c.renderTotal(u),
                            void (
                                s.page &&
        ...
        (j.prototype.sort = function (e, i, a, l) {
            ...
            (c.sortKey = { field: n, sort: i }),
                ...
                l && layui.event.call(e, s, "sort(" + h + ")", { field: n, type: i });
        }),
        (j.prototype.loading = function (e) {
            ...
            a.loading &&
                (e
                    ? (i.layInit && i.layInit.remove(), delete i.layInit, i.layBox.find(m).remove())
                    : ((i.layInit = t(['<div class="layui-table-init">', '<i class="layui-icon layui-icon-loading layui-icon"></i>', "</div>"].join(""))), i.layBox.append(i.layInit)));
        }),
        ...
        (j.prototype.events = function () {
            ...
            a.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
                ...
                o
                    ...
                    layui.event.call(this, s, "checkbox(" + p + ")", v.call(this, { checked: n, type: o ? "all" : "one" }));
            }),
                a.elem.on("click", 'input[lay-type="layTableRadio"]+', function () {
                    ...
                    layui.each(l, function (e, t) {
                        ...
                        layui.event.call(this, s, "radio(" + p + ")", v.call(this, { checked: i }));
                }),
                a.layBody
    ...
    var s = function (t, i, a) {
            ...
            var o = n.contents(),
                ...
                s = e(
                    [
                        "<style>",
                        "*{margin: 0; padding: 0;}",
                        "body{padding: 10px; line-height: 20px; overflow-x: hidden; word-wrap: break-word; font: 14px sans-serif Neue,Helvetica,PingFang SC,Microsoft YaHei,Tahoma,Arial,sans-serif; -webkit-box-sizing: border-box !important; -moz-box-sizing: border-box !important; box-sizing: border-box !important;}",
            ...
            var l = this,
                n = i.open({
                    ...
                    content: [
                        ...
                        '<button type="button" lay-submit lay-filter="layedit-link-yes" class="layui-btn"> Ok </button>',
        ...
        x = function (t) {
            var a = (function () {
                ...
                return (
                    layui.each(t, function (t, i) {
                        e[i] = layui.cache.dir + "CesiumPlugins/drawingtools/images/face/" + t + ".gif";
                    }),
                    e
                );
            })();
            ...
            var e = this,
                l = i.open({
                    ...
                    content: [
                        ...
                        "</li>",
                        '<li class="layui-form-item" style="text-align: center;">',
                        '<button type="button" lay-submit lay-filter="layedit-code-yes" class="layui-btn"> Ok </button>',
                        '<button style="margin-left: 20px;" type="button" class="layui-btn layui-btn-primary"> Cancel </button>',
                        "</li>",
                        "</ul>",
                    ].join(""),
