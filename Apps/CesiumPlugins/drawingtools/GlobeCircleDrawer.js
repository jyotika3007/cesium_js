...
GlobeCircleDrawer.prototype = {
    ...
    okHandler: null,
    cancelHandler: null,
    dragIcon: "CesiumPlugins/drawingtools/images/circle_center.png",
    ...
    startDrawCircle: function (okHandler, cancelHandler) {
        ...
        _this.drawHandler.setInputAction(function (event) {
            ...
            _this.tooltip.showAt(position, "<p>Choose the end point</p>");
    ...
    _showCircleOutline2Map: function () {
        ...
        _this.outlineEntity.istemporary = true;
    },
