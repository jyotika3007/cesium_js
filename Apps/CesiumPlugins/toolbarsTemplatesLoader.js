...
function leftToolbarLoader() {
    ...
    $(document.body).append($(`<div id="toolbar2" style="position:absolute;margin-left: 0vh;">
        ...
        <span><img class="cesiumImg_style" src="./img/layers.png" ></span>
        </div>
        </div>
        </td>
        </tr>
        ...
        <span><img class="cesiumImg_style" src="./img/brickwall.png" ></span>
        </div>
        <div class="divider"></div>
        <div class="button" id="drawAddWeapon" title="Deploy Weapons" style="display: block">
        <span><img class="cesiumImg_style" src="./img/weapons.png" ></span>
        </div>
        <div class="divider"></div>
        <div class="button" id="drawBufferLine" title="Draw Buffer Line">
        <span><img class="cesiumImg_style" src="./img/doodle.png" ></span>
        </div>
        <div class="button" id="straightArrow" title="Draw Straight Arrow">
        <span><img class="cesiumImg_style" src="./img/right-arrow.png" ></span>
        </div>
        <div class="button" id="attackArrow" title="Draw Curved Arrow">
        <span><img class="cesiumImg_style" src="./img/right.png" ></span>
        </div>
        
        <div class="divider"></div>
        <div class="button" id="editShape" title="Edit Shape">
        <span><img class="cesiumImg_style" src="./img/edit.png" ></span>
        </div>
        <div class="button" id="deleteShape" title="Delete Shape">
        <span><img class="cesiumImg_style" class="cesiumImg_style" src="./img/delete2.png" ></span>
        </div>
        </div>
        </div>
        </td>
        ...
        <span><img class="cesiumImg_style" src="./img/terrain_profile.png"></span>
        </div>
        </div>
        </div>
        </td>
        ...
        <span><img class="cesiumImg_style" src="./img/sun.png" ></span>
        </div>
        <div class="button" title="Weather Settings" onclick="toggleConfigurations();">
        <span><img class="cesiumImg_style" src="./img/cloudy.png" ></span>
        </div>
...
function colorPickerLoader() {
    ...
    $(".cpBG").prepend($(`<div style="width: 100%;
        ...
        <br>
        <label>Stroke Width:<input type="number" style="width: 50%; text-align: center;" min="1" max="1000" value="${default_draw_line_width}" step="1" onchange="default_draw_line_width_changed(this);"><span id="widm">${default_draw_line_width}m</span></label>
        <hr>
        </div>`));
...
function infoToolbarLoader(objId, _symbolData, _cb) {
    ...
    if (objId && _symbolData && !_symbolData["displayInfo"]) {
        ...
        if(_symbolData["position"] !== undefined &&_symbolData["position"]["lon"] !== undefined && _symbolData["position"]["lon"]){
            ...
            get_symbol_position = _symbolData["position"]
            console.log(get_symbol_position)
            cartographic = Cesium.Cartographic.fromCartesian(get_symbol_position)
                    // console.log(cartographic)       
                    var latitude = Cesium.Math.toDegrees(cartographic.latitude);
                    var longitude = Cesium.Math.toDegrees(cartographic.longitude);
                    
                    infoHtml += `       <tr><td style="color:lightcoral">Location</td><td style="color:lightcoral">Lat&nbsp;</td><td>${(latitude).toFixed(3)}\u00B0</td></tr>
                    <tr><td></td><td style="color:lightcoral">Lon&nbsp;</td><td>${(longitude).toFixed(3)}\u00B0</td></tr>`
                }
                ...
                if (_symbolData.shapeType && selected_Entity && _symbolData.shapeType.toLowerCase() == "weapon" && _symbolData["WPN_EQPT"]) {
                    switch (_symbolData["WPN_EQPT"].toLowerCase()) {
                        ...
                        if (selected_Entity.viewModel) {
                            ...
                            <input class="slider" type="range" min="`+_symbolData.down_elevation+`" max="`+_symbolData.up_elevation+`" step="0.5"
        ...
        if ((_symbolData.shapeType == "Point" || _symbolData.shapeType == "Text") && selected_Entity.viewModel) {
            ...
            if (_symbolData.shapeType == "Text") {
                infoHtml += `<tr><td colspan="3"><hr></td></tr>
                <tr>
                <td>Font</td>
                <td>
                <select id="textFontList" data-bind="value: font" style="width:100%;">
                ...
                <tr>
                <td>Fill Color:</td><td><input type="checkbox" data-bind="checked: fill"></td>
                </tr>
                <tr>
                <td colspan="3">
                <table style="100%;">
                <tr>
                <td>Red</td><td>Green</td><td>Blue</td><td>Alpha</td>
                </tr>
                <tr class="text_fill_color">
                <td>
                <input type="number" class="fillColorRed" style="width:100%;" min="0" max="255" step="1" data-bind="value: fillColorRed" disabled>
                </td><td>
                <input type="number" class="fillColorGreen" style="width:100%;" min="0" max="255" step="1" data-bind="value: fillColorGreen" disabled>
                </td><td>
                <input type="number" class="fillColorBlue" style="width:100%;" min="0" max="255" step="1" data-bind="value: fillColorBlue" disabled>
                </td><td>
                <input type="number" style="width:100%;" min="0" max="1.0" step="0.1" data-bind="value: fillColorAlpha">
                </td>
                </td>
                <td>
                <input type="color" class="text_color_change" value="#ffffff" data-bind="style: {'width':'40px', 'height':'20px'}">
                </td>
                </tr>
                </table>
                </td>
                ...
                <tr>
                <td>Stroke Color:</td><td><input type="checkbox" data-bind="checked: stroke"></td>
                </tr>
                <tr>
                <td colspan="3">
                <table style="100%;">
                <tr>
                <td>Red</td><td>Green</td><td>Blue</td><td>Alpha</td>
                </tr class="text_stroke_color">
                <tr>
                <td>
                <input type="number" class="strokeColorRed" style="width:100%;" min="0" max="255" step="1" data-bind="value: strokeColorRed" disabled>
                </td><td>
                <input type="number" class="strokeColorGreen" style="width:100%;" min="0" max="255" step="1" data-bind="value: strokeColorGreen" disabled>
                </td><td>
                <input type="number" class="strokeColorBlue" style="width:100%;" min="0" max="255" step="1" data-bind="value: strokeColorBlue" disabled>
                </td><td>
                <input type="number" style="width:100%;" min="0" max="1.0" step="0.1" data-bind="value: strokeColorAlpha">
                </td>
                </td><td>
                <input type="color" class="stroke_color_change" value="#000000" data-bind="style: {'width':'40px', 'height':'20px'}">
                </td>
                </tr>
                </table>
                </td>
                ...
                <tr class="text_background_color">
                <td>
                <input type="number" class="bgColorRed" style="width:100%;" min="0" max="255" step="1" data-bind="value: bgColorRed" disabled>
                </td><td>
                <input type="number" class="bgColorGreen" style="width:100%;" min="0" max="255" step="1" data-bind="value: bgColorGreen" disabled>
                </td><td>
                <input type="number" class="bgColorBlue" style="width:100%;" min="0" max="255" step="1" data-bind="value: bgColorBlue" disabled>
                </td><td>
                <input type="number" style="width:100%;" min="0" max="1.0" step="0.1" data-bind="value: bgColorAlpha">
                </td>
                </td><td>
                <input type="color" class="bg_color_change" value="#000000" data-bind="style: {'width':'40px', 'height':'20px'}">
                </td>
                </tr>
                </table>
                </td>
